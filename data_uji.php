...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary"><span class="fas fa-fw fa-chart-o"></span> Data Uji</h6>
    </div>
    <div class="card-body">
      ...
      <a href="index.php?halaman=hapus_semua_data_uji" class="btn btn-primary"><span class="fa fa-cog"></span> Hapus Semua Data</a>
      <a href="index.php?halaman=lexicon_based_uji" class="btn btn-primary"><span class="fa fa-book"></span> Label otomatis</a>
      <br><br>
