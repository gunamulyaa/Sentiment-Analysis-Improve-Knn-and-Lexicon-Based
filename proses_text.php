  ...
  $pengaduan = mysqli_query($koneksi,"SELECT * FROM documents ORDER BY doc_id") or die(mysqli_error($koneksi)); // ga dipake
  ...
  $n = mysqli_num_rows($resn); //cek jumlah total pengaduan
...
// PERHITUNGAN LEXICON BASED
  ...
  if($resUpdateBobot){
      ...
      <script language="JavaScript">
        alert('Successfully');
        document.location='index.php?halaman=hasil_filtering';
      </script>
      <?php
  }else
  {
