...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<h4 class="small font-weight-bold">Positif <span
				class="float-right"><?php echo $positif; ?> Data</span></h4>
				<div class="progress mb-4">
					<div class="progress-bar" role="progressbar" <?php echo "style='width:$percentage_positif%; background-color:#36A2EB;'"; ?>
					aria-valuenow="<?php echo $positif; ?>" aria-valuemin="0" aria-valuemax="<?php echo $sum_all; ?>"></div>
				</div>
				<h4 class="small font-weight-bold">Negatif <span
					class="float-right"><?php echo $negatif; ?> Data</span></h4>
					<div class="progress mb-4">
						<div class="progress-bar" role="progressbar" <?php echo "style='width:$percentage_negatif%; background-color:#FF6384;'"; ?>
						aria-valuenow="<?php echo $negatif; ?>" aria-valuemin="0" aria-valuemax="<?php echo $sum_all; ?>"></div>
					</div>
					<h4 class="small font-weight-bold">Netral <span
						class="float-right"><?php echo $netral; ?> Data</span></h4>
						<div class="progress mb-4">
							<div class="progress-bar" role="progressbar" <?php echo "style='width:$percentage_netral%; background-color:#1aeb7b;'"; ?>
							aria-valuenow="<?php echo $netral; ?>" aria-valuemin="0" aria-valuemax="<?php echo $sum_all; ?>"></div>
						</div>
     ...
     */
     ...
     var donutData = [
     { label: 'SESUAI', data: <?php echo $sum_true; ?>, color: '#3c8dbc' },
     { label: 'TIDAK SESUAI', data: <?php echo $sum_false; ?>, color: '#DC143C' }
     ]
